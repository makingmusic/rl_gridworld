...
class QLearningAgent2D:
    def __init__(self, actions, learning_rate=0.1, discount_factor=0.99, epsilon=1.0, 
                 epsilon_decay=0.99, epsilon_min=0.1, exploration_strategy="epsilon_greedy", 
                 temperature=1.0, temperature_decay=0.99, temperature_min=0.1):
        """
        Initialize the Q-learning agent for 2D gridworld.
        ...
        :param temperature_decay: Multiplicative factor to decay temperature each episode.
        ...
        self.q_table = {}  # format: {(x,y): {'up': value, 'down': value, 'left': value, 'right': value}, ...}
    ...
    def update_q_value(self, state, action, reward, next_state, done):
        ...
        # Ensure next_state is in Q-table
