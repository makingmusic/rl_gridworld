...
Note2Self: 100x100 grid trained in about 2 hours / 325 episodes on an M3 Mac / 24 Gb. Need to do more benchmarking / profiling. So much time is wasted in just measuring while training. Measuring ought to occur on a separate machine i I really want to do this properly.
